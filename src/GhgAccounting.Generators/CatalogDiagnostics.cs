...
{
    private const string Category = "GhgAccounting.Catalog";
    ...
    public static readonly DiagnosticDescriptor UnverifiedInStrictBuild = new DiagnosticDescriptor(
        ...
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Set GhgRequireVerifiedCatalog=false for local development. The release pipeline sets it to true so that unchecked numbers can never reach a published package.");
