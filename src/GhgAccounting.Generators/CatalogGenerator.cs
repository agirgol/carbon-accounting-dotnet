...
using GhgAccounting.Generators.Json;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.Diagnostics;
using Microsoft.CodeAnalysis.Text;

namespace GhgAccounting.Generators;
...
public sealed class CatalogGenerator : IIncrementalGenerator
{
    ...
    private const string StrictPropertyKey = "build_property.GhgRequireVerifiedCatalog";

    private const string Ns = "global::GhgAccounting";
    ...
    private static void EmitGwpTables(SourceProductionContext production, ImmutableArray<CatalogFile> files, bool requireVerified)
    {
        ...
        AppendHeader(output);
        output.AppendLine("namespace GhgAccounting");
        output.AppendLine("{");
    ...
    private static void EmitFactorSets(SourceProductionContext production, ImmutableArray<CatalogFile> files, bool requireVerified)
    {
        ...
        var output = new StringBuilder();
        AppendHeader(output);
        output.AppendLine("namespace GhgAccounting.Factors");
        output.AppendLine("{");
    ...
    private static void AppendHeader(StringBuilder output)
    {
        ...
        output.AppendLine("// Generated by GhgAccounting.Generators from the JSON catalog under data/.");
